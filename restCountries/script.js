...
displayCountries(countreis)
//   flag
// country name
//  population
// capital
// region
function displayCountries(countreis){
  let htmlData=``
for(let c of countreis){
  htmlData+=`
  <div class="col-4 mt-3">
                <div class="card" style="width: 100%;">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item">Currencies:${c.currencies}</li>
                    </ul>
                    <div class="card-body">
...
countreis.map(c=>regionSet.add(c.region))
/* console.log(regionSet);*/


displayRegions(regionSet)
function displayRegions(region){
  let data=``
...
function filterCountriesByRegion(region){
  console.log(region);
  let regionCountries=countreis.filter(c=>c.region==region)
...
function displayCountry(){
  ...
  console.log(cname);
  let data=countreis.find(c=>c.name==cname)
  console.log(data);
  let htmlData=`
  <div class="col-4"></div>
  <div class="col-4 mt-3">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Currencies:${data.currencies}</li>
              </ul>
              <div class="card-body">
                <a href="#" class="card-link">Card link</a>
                <a href="#" class="card-link">Another link</a>
